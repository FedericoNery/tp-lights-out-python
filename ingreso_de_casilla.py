def validacionIngresoDeCasillero(dimensionTablero):
    ...
    while(not ingresoDeCoordenada):
        ...
        if(longitudDeCoordenadaValida(coordenadaDelUsuario) and letraDeCoordenadaValida(coordenadaDelUsuario,letraUltimaColumnaDelTablero)
           and numeroDeCoordenadaValida(coordenadaDelUsuario,numeroUltimaFilaDelTablero)):
